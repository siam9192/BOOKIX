...
const createCategoryIntoDB = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    const category = yield category_model_1.Category.exists({ name: payload.name });
    // Checking is the category already exists with the same name
    if (category) {
        throw new AppError_1.default(http_status_1.default.NOT_ACCEPTABLE, 'Category already exists');
    }
...
const deleteCategoryFromDB = (categoryId) => __awaiter(void 0, void 0, void 0, function* () {
    const deleteStatus = yield category_model_1.Category.deleteOne({ _id: (0, func_1.objectId)(categoryId) });
    if (!deleteStatus.deletedCount) {
        throw new AppError_1.default(http_status_1.default.BAD_REQUEST, 'Category can not be deleted. something went wrong');
    }
    return null;
});
