...
const getBooksFromDB = (query) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    // Filtering books
    let result = yield new QueryBuilder_1.default(
      book_model_1.Book.find(),
      query,
    )
      .textSearch()
      .find()
...
const getFreeDeliveryBooksFromDB = (query) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const deleteBookFromDB = (bookId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    return book_model_1.Book.findByIdAndUpdate(
      bookId,
      { is_deleted: true },
      { new: true },
    );
  });
const updateBookIntoDB = (bookId, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const book = yield book_model_1.Book.findById(bookId);
...
const unpauseBookIntoDB = (bookId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const book = yield book_model_1.Book.findById(bookId);
    // Checking book existence and is the book already paused
    if (!book) {
...
const getBooksBasedOnDiscountFromDB = (discount, query) =>
  __awaiter(void 0, void 0, void 0, function* () {
