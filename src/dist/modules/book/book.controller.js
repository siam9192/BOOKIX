...
const createMultipleBooks = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield book_service_1.BookService.createMultipleBooksIntoDB(
      req.body,
    );
    (0, response_1.sendSuccessResponse)(res, {
      statusCode: http_status_1.default.CREATED,
...
const getBooks = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const getFeaturedBooks = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const getSuggestBooks = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const getRecentlyViewedBooks = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const bookIds = req.body.book_ids;
    const result =
      yield book_service_1.BookService.getRecentlyViewedBooks(bookIds);
    (0, response_1.sendSuccessResponse)(res, {
      statusCode: http_status_1.default.OK,
...
const updateBook = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const bookId = req.params.bookId;
    const result = yield book_service_1.BookService.updateBookIntoDB(
      bookId,
      req.body,
    );
    (0, response_1.sendSuccessResponse)(res, {
...
const pauseBook = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const bookId = req.params.bookId;
...
const unpauseBook = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const bookId = req.params.bookId;
...
const getBooksBasedOnDiscount = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const discount = req.params.percentage;
    const result =
      yield book_service_1.BookService.getBooksBasedOnDiscountFromDB(
        discount,
        req.query,
      );
    (0, response_1.sendSuccessResponse)(res, {
...
const getRelatedBooks = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const bookId = req.params.bookId;
    const result =
      yield book_service_1.BookService.getRelatedBooksFromDB(bookId);
    (0, response_1.sendSuccessResponse)(res, {
      statusCode: http_status_1.default.OK,
...
const getFreeDeliveryBooks = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield book_service_1.BookService.getFreeDeliveryBooksFromDB(
      req.query,
    );
    (0, response_1.sendSuccessResponse)(res, {
      statusCode: http_status_1.default.OK,
