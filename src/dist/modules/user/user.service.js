...
const createUserIntoDB = (payload, registered_by) =>
...
const getUsers = (query) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield new QueryBuilder_1.default(
...
const changeUserBlockStatusIntoDB = (payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const changeUserRoleIntoDB = (payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    return yield user_model_1.User.findByIdAndUpdate(payload.userId, {
      role: payload.role,
    });
