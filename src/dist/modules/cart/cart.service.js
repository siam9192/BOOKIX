...
const createCartItemIntoDB = (userId, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!book) {
      ...
      throw new AppError_1.default(
        ...
        'This Book can not be add to cart',
      );
    }
    ...
    if (cartItem) {
      throw new AppError_1.default(
        http_status_1.default.NOT_ACCEPTABLE,
        'This book already on your cart',
      );
    }
...
const getCartItemsFromDB = (userId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    return yield cart_model_1.Cart.find({
      user: (0, func_1.objectId)(userId),
    }).populate('book');
  });
const getLocalCartItems = (payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const ids = payload.ids.map((id) => func_1.objectId);
    return yield cart_model_1.Cart.find();
  });
const updateCartItemQuantityIntoDB = (userId, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    return yield cart_model_1.Cart.findOneAndUpdate(
      {
        _id: (0, func_1.objectId)(payload.itemId),
        user: (0, func_1.objectId)(userId),
      },
      { quantity: payload.quantity },
    );
  });
const deleteCartItemFromDB = (userId, cartItemId) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const deleteMultipleCartItems = (cartItemIds) =>
  __awaiter(void 0, void 0, void 0, function* () {
