...
router.post(
  ...
  (0, validateRequest_1.default)(
    notification_validation_1.NotificationValidations
...
router.get(
  ...
  notification_controller_1.NotificationController.getUserNotifications,
);
router.patch(
  '/make-as-read',
  (0, auth_1.default)(...Object.values(user_interface_1.TRole)),
  notification_controller_1.NotificationController.makeAsReadNotifications,
);
