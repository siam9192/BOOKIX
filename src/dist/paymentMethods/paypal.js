...
const pay = (res, amount, paymentId) => __awaiter(void 0, void 0, void 0, function* () {
    const paymentJson = {
        intent: 'sale',
        payer: {
...
exports.pay = pay;
const executePayment = (paymentId, payerId, callFun) => __awaiter(void 0, void 0, void 0, function* () {
    paypal_rest_sdk_1.default.payment.execute(paymentId, { payer_id: payerId }, function (error, payment) {
        ...
        if (error) {
            ...
            if (paymentTransactions &&
                ((_a = paymentTransactions.related_resources) === null || _a === void 0 ? void 0 : _a.length)) {
...
const refund = (saleId, amount, redirect_url, res) => {
    ...
    try {
        paypal_rest_sdk_1.default.sale.refund(saleId, data, function (error, refund) {
            if (error) {
                // throw new Error()
